...
_magic_number = 6
_modified_time = 1417441658.031306
_template_filename=u'templates/show_params.mako'
_template_uri=u'/show_params.mako'
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f5a181f6050', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f5a181f6050')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f5a181f6050')._populate(_import_ns, [u'render_msg'])
